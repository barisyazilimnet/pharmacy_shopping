...
<div class="mobile-sticky js__menu_sticky">
	<div class="container">
		<div class="left-side">
			<a href="index.php" class="logo"><img src="http://localhost/pharmacy_shopping/login/upload/sitelogo/site.png" alt="" /></a>
		</div>
	...
	// js ile sepet işlemlerinin  sepet ekle ve sepeten ürün silme 
		$(document).ready(function() {
			$(".sepete_ekle").click(function() {
				var url = "http://localhost/pharmacy_shopping/tema/default/sepet_islemleri.php";
				var data = {
					islem: "Ekle",
